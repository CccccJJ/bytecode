...
public class NameAndTypeConstantInfoCp extends AbstractConstantInfo {
...
//        }
        ...
        strings.add(MessageFormat.format("#{0} = NameAndType            #{1}.#{2}", INDEX.getAndIncrement(), index1, index2));
