...
public class FieldRefConstantInfoCp extends AbstractConstantInfo {

    public static final Integer TAG = 9;
...
//        }
        ...
        strings.add(MessageFormat.format("#{0} = Fieldref            #{1}.#{2}", INDEX.getAndIncrement(), index1, index2));
