...
public class InterfaceMethodRefConstantInfoCp extends AbstractConstantInfo {

    public static final Integer TAG = 11;
...
//        }
        ...
        strings.add(MessageFormat.format("#{0} = InterfaceMethodref            #{1}.#{2}", INDEX.getAndIncrement(), index1, index2));
